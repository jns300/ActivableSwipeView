...
namespace Platform.MinorHelper
{
    internal static partial class ViewExtensions
    {
        ...
        internal static double ExtractAngleInDegrees(this Matrix4x4 matrix) => matrix.ExtractAngleInRadians() * 180 / Math.PI;
        ...
        internal static ParentView GetParent(this PlatformView view)
        {
            return view?.Parent;
        }

        internal static ParentView GetParent(this ParentView view)
        {
            return view?.Parent;
        }
    }
