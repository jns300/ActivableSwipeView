...
{
	internal partial class ImageSourcePartLoader
	{
		...
		internal global::Platform.Images.ImageSourceServiceResultManager SourceManager { get; } = new global::Platform.Images.ImageSourceServiceResultManager();
		...
		public async Task UpdateImageSourceAsync()
		{
			...
			{
#if IOS || ANDROID || WINDOWS || TIZEN
				_imageSourceServiceProvider ??= ActivableSwipeView.Helper.ElementHandlerExtensions.GetRequiredService<IImageSourceServiceProvider>(handler);
#endif
