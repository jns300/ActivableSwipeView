...
#pragma warning disable CS8600, CS8603, CS8604
    internal static class ContextExtensions
    {
        ...
        // _TODO FromPixels/ToPixels is both not terribly descriptive and also possibly sort of inaccurate?
        ...
        public static void HideKeyboard(this Context self, View view)
        {
        ...
        public static void ShowKeyboard(this Context self, View view)
        {
        ...
        public static (int left, int top, int right, int bottom) ToPixels(this Context context, Android.Graphics.Rect rectangle)
        {
            return
            (
        ...
        internal static int GetDisabledThemeAttrColor(this Context context, int attr)
        {
            ...
            using (var value = new TypedValue())
            {
                ...
                return context.GetThemeAttrColor(attr, disabledAlpha);
            }
        }
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        {
            int color = context.GetThemeAttrColor(attr);
        ...
        internal static Color GetAccentColor(this Context context)
        {
            ...
            using (var value = new TypedValue())
            {
                if (context.Theme != null)
                {
                    if (context.Theme.ResolveAttribute(AAttribute.ColorAccent, value, true)) // Android 5.0+
                    {
